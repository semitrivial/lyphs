...
void init_command_table(void)
{
  ...
  add_handler( "all_bulk_annots", handle_all_bulk_annots_request, CMD_READONLY );
  ...
  add_handler( "lyphs_located_in_term", handle_lyphs_located_in_term_request, CMD_READONLY );
